...
- 종종 Sub quest로 같은 수업을 듣는 동기(그루)들과 pair programming을 하고 상호 평가를 진행하기도 합니다.
  ...
  - 동료의 repository를 fork해와서 사용하고 있으나 Repository 가독성 및 폴더 관리를 위해 subtree기능을 사용해 위 폴더로 옮기고 원본은 삭제하는 방식으로 관리하고 있습니다.
- 그 외에 Exploration 은 CV, NLP 분야의 다양한 실습(아웃포커싱 사진만들기, 강아지 vs 고양이 이미지 분류기 등) 결과물을 정리하고 있습니다.
