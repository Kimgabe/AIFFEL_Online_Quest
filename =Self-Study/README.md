...
---
## PR미션(김승순) <br>
comment : 일단 16년의 기사지만, 당시에는 복잡하던 smarthome 기술이 이제는 보편화 되다시피한 점에서 AI기술의 급격한 발전 속도와 상용화 속도에 놀랐다. 당시의 구현결과는 어찌보면 STT등에 베이스를 둔 명령어의 단순화 및 프로그래밍된 명령 잉행이었다면 최근에는 GPT4의 등장으로 더 쉽게 사람의 언어를 이해하고, 이에 적합한 명령 실행이 가능할테니, 훨씬 더 자비스에 가까워 진게 아닐까?
